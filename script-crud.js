...
function criarElementoTarefa(tarefa) {
  ...
  botao.onclick = () => {
    const input = prompt("Digite a nova descrição da tarefa:");
...
const removerConcluidas = (somenteCompletas) => {
...
btnRemoverConcluidas.onclick = () => removerConcluidas(true);

btnRemoverTodas.onclick = () => removerConcluidas(false);
